...
#| label: sum_stats
#| fig-cap: "This is a summary table."
...
#| label: tbl_reg
#| fig-cap: "These are regression results for whether patients improved or not. Improvement is categorized as binomial therefore the glm method was used in the regression model."
tbl_uvregression(
	modified_data,
	y = improved,
	include = c(gender, arm, dose_strep_g, baseline_cavitation,
...
```{r}
#nline R code printing something else (like we did with the mean age in the example) (1 pt) 
...
@fig-hist contains a histogram and @sum_stats contains a table of descriptive statistics
